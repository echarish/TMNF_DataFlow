...
export class CPCostData extends Component {


    render() {

        let dataArray = findProcessDataType('pc_cpcost', this.props.dataType);
        ...
        let tableRow = dataArray.map(function (dataArrayData, index) {
            return <tr key={index}>
                ...
                <td className="Maroon">{dataArrayData.ID}</td>
                <td className="Orange">{dataArrayData.CPBuildingCov}</td>
